...
import styles from './SpfxGraphPlannerTypescript.module.scss';
import { ISpfxGraphPlannerTypescriptProps } from './ISpfxGraphPlannerTypescriptProps';
import { escape } from '@microsoft/sp-lodash-subset';

export default class SpfxGraphPlannerTypescript extends React.Component<ISpfxGraphPlannerTypescriptProps, {}> {
  public render(): React.ReactElement<ISpfxGraphPlannerTypescriptProps> {
    return (
      <div className={ styles.spfxGraphPlannerTypescript }>
